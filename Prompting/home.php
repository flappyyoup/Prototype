...
<body>
    ...
    <div class="navbar">
        ...
        <div style="display: flex; align-items: center; gap: 30px;">
            ...
            <div class="notification-container" style="position: relative;">
                <a href="notification.php" style="color: white; font-size: 24px; text-decoration: none;">
    ...
    <div class="slider">
        ...
        <button class="button" onclick="window.location.href='market.php'">SANGLA NOW</button>
    ...
    <section style="background-color: #f3cf7a; padding: 7rem 2rem;">
        <div style="display: flex; justify-content: center; align-items: normal; gap: 40px; flex-wrap: wrap;">
            ...
            <!-- Center Estimator -->
            <div onclick="window.location.href='sangla.php'" style="
                position: relative;
                width: 350px;
                height: 350px;
                border-radius: 25px;
