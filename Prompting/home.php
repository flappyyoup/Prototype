...
<body>
    ...
    <div class="navbar">
        ...
        <div class="nav-icons">
            ...
            <a href="branches.php" data-tooltip="Branches">📍</a>
    ...
    <div class="slider">
        <div class="slides">
            <div class="slide">
                <img src="images/landing.jpg" alt="Slide 1">
            </div>
            <div class="slide">
                <img src="https://via.placeholder.com/1200x400.png?text=Slide+2" alt="Slide 2">
            </div>
            <div class="slide">
    ...
    <section class="items-section" id="items-section">
        ...
        <div class="items-container">
            <div class="item" onclick="window.location.href='marketplace.php?category=necklace'">
                <img src="https://via.placeholder.com/200x200.png?text=Necklace" alt="Necklace">
                <p>Necklace</p>
            </div>
            <div class="item" onclick="window.location.href='marketplace.php?category=earrings'">
                <img src="https://via.placeholder.com/200x200.png?text=Earrings" alt="Earrings">
                <p>Earrings</p>
            </div>
            <div class="item" onclick="window.location.href='marketplace.php?category=ring'">
                <img src="https://via.placeholder.com/200x200.png?text=Ring" alt="Ring">
                <p>Ring</p>
            </div>
            <div class="item" onclick="window.location.href='marketplace.php?category=watch'">
                <img src="https://via.placeholder.com/200x200.png?text=Watch" alt="Watch">
                <p>Watch</p>
            </div>
            <div class="item" onclick="window.location.href='marketplace.php?category=bracelet'">
                <img src="https://via.placeholder.com/200x200.png?text=Bracelet" alt="Bracelet">
                <p>Bracelet</p>
            </div>
        </div>
    </section>
    ...
    <section class="about-section" id="about">
        <h2>About Us</h2>
        <p>
            Welcome to iPawnShop, your trusted partner in financial solutions. We provide secure and reliable pawn services, helping you unlock the value of your assets. Our mission is to empower individuals with quick and easy access to funds while ensuring transparency and trust.
        </p>
    </section>
